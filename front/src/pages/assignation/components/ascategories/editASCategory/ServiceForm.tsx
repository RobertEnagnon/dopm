...
export const Form = (props: { onSubmit: SubmitHandler<CategoryEditType>, validationSchema: SchemaOf<CategoryEditType>, initialValues: CategoryEditType }) => {
    const {
        onSubmit,
        validationSchema,
        initialValues
