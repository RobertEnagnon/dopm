...
export const Form = (props: { onSubmit: SubmitHandler<EditClassificationType>, validationSchema: SchemaOf<EditClassificationType>, initialValues: EditClassificationType }) => {
  const {
    onSubmit,
    validationSchema,
    initialValues
  ...
  const {
    ...
    control,
    formState: { errors }
  } = useForm<EditClassificationType>({
