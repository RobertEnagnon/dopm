...
const Images = (props: { previewImg: string[], watch: UseFormWatch<FicheAdd>, control: Control<FicheAdd, any>, values: FicheAdd, handleFileUpload: Function, setImageToChange: Function, setIsDialogOpen: Function, setValue: Function }) => {
  ...
  useEffect(() => {
    if (watch("image1") === undefined && watch("image2") === undefined && watch("image3") === undefined) {
            ...
            >
              ...
              >
                <Grid item>
                  ...
                  >
                    {!watch("image1") ? t("ficheSecuriteCreation.add") : t("ficheSecuriteCreation.update")}
                  </Button >
                </Grid >
                <Grid item>
                  <IconButton
            ...
            >
              ...
              >
                <Grid item>
                  ...
                  >
                    {!watch("image2") ? t("ficheSecuriteCreation.add") : t("ficheSecuriteCreation.update")}
                  </Button >
                </Grid >
                <Grid item>
                  <IconButton
            ...
            >
              ...
              >
                <Grid item>
                  ...
                  >
                    {!watch("image3") ? t("ficheSecuriteCreation.add") : t("ficheSecuriteCreation.update")}
                  </Button >
                </Grid >
                <Grid item>
                  <IconButton
