...
import { Notification } from "../../../models/FicheSecurite/notification";
import { useZone } from "../../../hooks/zone";
import { useResponsible } from "../../../hooks/responsible";
import { GetFSNotificationsPerZone, UpdateFSNotification } from "../../../services/FicheSecurite/fsNotifications";
...
export default function Notifications() {
  ...
  useEffect(() => {
    if (selectedZone) {
      GetFSNotificationsPerZone(selectedZone.id).then((r) => {
