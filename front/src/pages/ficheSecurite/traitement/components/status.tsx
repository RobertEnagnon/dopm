...
const Status = (props: { watch: UseFormWatch<FicheAdd>, control: Control<FicheAdd, any>, errors: FieldErrorsImpl<DeepRequired<FicheAdd>>, submitted: boolean, setValue: Function, values: FicheAdd }) => {
