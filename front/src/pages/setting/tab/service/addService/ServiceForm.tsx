...
export const Form = (props: { onSubmit: SubmitHandler<AddServiceType>, validationSchema: SchemaOf<AddServiceType>, initialValues: AddServiceType }) => {
  const {
    onSubmit,
    validationSchema,
    initialValues
